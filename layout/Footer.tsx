...
export default function Footer() {
  return (
    <footer className="mt-[-200px] pb-5">
      ...
      <div className="px-20 bg-[#181818] text-white flex">
        <div className="w-full h-[70vh] max-h-[500px] flex flex-col items-center justify-center">
          <h3 className="font-bold text-5xl w-1/2 text-center leading-tight">
          ...
          <div className="pt-7 flex gap-x-5">
            <input
              type="text"
              className="bg-transparent  focus:outline-none border-b-[1px] border-b-[#F3F5F7] pb-2 text-xl text-center w-80"
